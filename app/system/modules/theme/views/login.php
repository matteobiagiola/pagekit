                ...
                <form class="js-login js-toggle uk-form tm-form" action="<?= $view->url('@user/authenticate') ?>" method="post">
                    ...
                    <div class="uk-panel uk-panel-box">
                        ...
                        <div class="uk-form-row">
                            <input class="uk-form-large uk-width-1-1" type="text" id="username" name="credentials[username]" value="<?= $this->escape($last_username) ?>" placeholder="<?= __('Username') ?>" autofocus>
                        </div>

                        <div class="uk-form-row">
                            <input class="uk-form-large uk-width-1-1" type="password" id="password" name="credentials[password]" value="" placeholder="<?= __('Password') ?>">
                        </div>
