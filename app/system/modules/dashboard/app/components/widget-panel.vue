        ...
        <div class="uk-panel-badge" v-if="!type.disableToolbar">
            <ul class="uk-subnav pk-subnav-icon">
                <li v-show="type.editable !== false && !editing">
                    <a class="pk-icon-edit pk-icon-hover" :title="'Edit' | trans" data-uk-tooltip="{delay: 500}" @click.prevent="edit"></a>
                </li>
                <li v-show="!editing">
                    <a class="pk-icon-handle pk-icon-hover uk-sortable-handle" :title="'Drag' | trans" data-uk-tooltip="{delay: 500}"></a>
                </li>
                <li v-show="editing">
