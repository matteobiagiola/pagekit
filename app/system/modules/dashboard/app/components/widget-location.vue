<template>
    ...
    <div class="uk-panel-badge">
        <ul class="uk-subnav pk-subnav-icon">
            <li v-show="!editing">
                <a class="pk-icon-contrast pk-icon-edit pk-icon-hover" :title="'Edit' | trans" data-uk-tooltip="{delay: 500}" @click.prevent="$parent.edit"></a>
            </li>
            <li v-show="!editing">
                <a class="pk-icon-contrast pk-icon-handle pk-icon-hover uk-sortable-handle" :title="'Drag' | trans" data-uk-tooltip="{delay: 500}"></a>
            </li>
            <li v-show="editing">
